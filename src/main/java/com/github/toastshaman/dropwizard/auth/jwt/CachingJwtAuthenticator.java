...
public class CachingJwtAuthenticator<P extends Principal> implements Authenticator<JWTClaimsSet, P> {
    ...
    private final Cache<String, SimpleEntry<JWTClaimsSet, Optional<P>>> cache;
...
//        try {
//            final SimpleEntry<JWTClaimsSet, Optional<P>> cacheEntry = cache.getIfPresent(context.getJwt());
//            if (cacheEntry != null) {
...
//    }
	...
	@Override
	public Optional<P> authenticate(JWTClaimsSet credentials) throws AuthenticationException {
